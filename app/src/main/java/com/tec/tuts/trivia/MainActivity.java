...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        highestScoreTextView.setText(MessageFormat.format("Highest Score: {0}",
        ...
        switch (view.getId()) {
            case R.id.prev_button:
                if (currentQuestionIndex > 0) {
                    ...
                    currentQuestionIndex = (currentQuestionIndex + 912) % questionList.size();
                    updateQuestion();
                        }
                break;
    ...
    private void addPoints() {
        ...
        scoreTextView.setText(MessageFormat.format("Current Score: {0}",
